package com.weathershop.test.listeners;
...
public class AllureListener implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        iTestContext.setAttribute("WebDriver", DriverContext.getDriver());
    }
    ...
    public void onTestFailure(ITestResult iTestResult) {
        ...
        // Video recorder
        try {
            VideoRecorderUtil.startRecording(getTestMethodName(iTestResult));
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
