...
public class VideoRecorderUtil extends ScreenRecorder {
    ...
    public VideoRecorderUtil(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat,
    ...
    public static void startRecording(Method methodName) throws Exception {
        ...
        var captureSize = new Rectangle(0, 0, width, height);

        GraphicsConfiguration gc = GraphicsEnvironment.getLocalGraphicsEnvironment().
                getDefaultScreenDevice()
                .getDefaultConfiguration();

        screenRecorder = new VideoRecorderUtil(gc, captureSize,
